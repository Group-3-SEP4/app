...
public class AddDevicePreference extends androidx.preference.DialogPreference {
    ...
    public AddDevicePreference(Context context, AttributeSet attrs, int defStyleAttr,
                              int defStyleRes) {
    ...
    public AddDevicePreference(Context context, AttributeSet attrs) {
     ...
     * {@link AddDevicePreference}. If no value has been set, the summary displayed will be 'Not
     * set', otherwise the summary displayed will be the value set for this preference.
     */
    public static final class SimpleSummaryProvider implements SummaryProvider<AddDevicePreference> {
        ...
        @Override
        public CharSequence provideSummary(AddDevicePreference preference) {
